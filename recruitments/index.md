...
숭실대학교 소프트웨어학부 **데이터이마이닝 연구실 (DMLAB)**에서 저희 연구실과 함께 성장할 학생분들을 모집힙니다! 

데이터마이닝 분야에서 연구에 관심이 있는 학생분들은 아래 사항을 살펴보시고 안내에 맞춰 지원을 해주세요.
...
* 매 방학마다 연구 주제와 관련이 있는 전공 스터디를 진행할 예정입니다. 스터디 참여자간의 논의를 통해 다음의 주제에서 하나를 선정하여 진행합니다 (아래는 예시이며 주제는 상황에 따라 변경될 수도 있습니다).
  * Data mining
  * Deep learning
  * Machine learning 
  * Recommender systems
